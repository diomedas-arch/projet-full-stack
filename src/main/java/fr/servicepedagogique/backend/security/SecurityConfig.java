    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cours/**", "/api/promotions/**", "/api/cours-planifies/**")
                                .authenticated()
                        .requestMatchers("/api/cours/**", "/api/promotions/**", "/api/cours-planifies/**")
                                .hasAuthority(RoleUtilisateur.ROLE_REFERENTE.name())
