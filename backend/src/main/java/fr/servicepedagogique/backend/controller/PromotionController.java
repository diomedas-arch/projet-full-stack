...
public class PromotionController {
    ...
    public PromotionController(
            ...
            PromotionConsultationService promotionConsultationService
    ) {
    ...
    @GetMapping("/{idPromotion}/detail")
    public PromotionDetailResponse consulterDetail(@PathVariable Integer idPromotion) {
    ...
    public List<PromotionResponse> listerParCursus(@PathVariable Integer idCursus) {
        return promotionService.listerParCursus(idCursus);
    }
